...
public abstract class PhanCung extends SanPham implements NhapCauHinh, HienThiCauHinh{
    ...
    public PhanCung(String maSP, String tenSP, float giaSP, int thoiGianBaoHanhSP, float trongLuongSP, String mauSacSP, int soLuongNhap, int soLuongXuat, int soLuongTonKho, boolean isNotDeleted, String loaiLinhKien, String nhaSanXuat, String model) {
