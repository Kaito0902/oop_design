...
public class QLNghiPhep {
    ...
    public void ghiVaoFileDSNP() {
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/NhanVien/danhSachDonNghiPhep.txt"))){
            for (NghiPhep ds : dsNghiPhep) {
    ...
    public void docTuFileDSNP() {
        try(BufferedReader reader = new BufferedReader(new FileReader("src/NhanVien/danhSachDonNghiPhep.txt"))) {
            String line;
